...
$(function(){
      ...
      if (!('webkitSpeechRecognition' in window)) {
          ...
          recognition.onstart = function() {
              ...
              $('#start_button').html('กำลังบันทึกเสียง กดเพื่อหยุด'); // เมื่อกดแล้วเปลี่ยนข้อความปุ่มเป็น คลิกอีกทีเพื่อหยุด หรือ Stop
          };

          recognition.onerror = function(event) {
              // ถ้าเกิดข้อผิดพลาด ทำงานส่วนนี้
              $('#instructions').html("เกิดข้อผิดพลาด"); // แจ้งสถานะถ้าเกิดข้อผิดพลาด
          };
          ...
          recognition.onend = function() {
              ...
              $('#start_button').html('พูด'); // เปลี่ยนข้อความปุ่มกดให้เป็นค่าเริ่มต้น
          };
...
//                console.log("final:    " + final_transcript);
          ...
          $("#start_button").click(function(e) {
              ...
              if (recognizing) { // ภ้าทำงานอยู่ เมื่อกดก็จะเป็นหยุด
                  ...
                  $('#start_button').html('พูดอีกครั้ง'); // เปลี่ยนข้อความปุ่ม แนะนำกดใหม่ ถ้าต้องการจดจำเสียงอีกครั้ง
